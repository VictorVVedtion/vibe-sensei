export const PRODUCT_URL = 'https://github.com/VictorVVedtion/vibe-sensei'

// Vibe Sensei Remote session URLs
 ...
 * vs_bridge_repl_v2_cse_shim_enabled (see isCseShimEnabled). Worker
