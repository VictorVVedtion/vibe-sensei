...
const DEFAULT_PREFIX = `You are Vibe Sensei, an AI trading terminal with 68 master guardians.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Vibe Sensei, an AI trading terminal, running within the Claude Agent SDK.`
...
function isAttributionHeaderEnabled(): boolean {
  ...
  return getFeatureValue_CACHED_MAY_BE_STALE('vs_attribution_header', true)
}
