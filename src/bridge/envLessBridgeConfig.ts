...
export type EnvLessBridgeConfig = {
  ...
  // nor onClose fires before this, emit vs_bridge_repl_connect_timeout
  ...
  // vs_bridge_min_version config so a v2-specific bug can force upgrades
 ...
 *
 * v2 analogue of checkBridgeMinVersion() — reads from vs_bridge_repl_v2_config
 * instead of vs_bridge_min_version so the two implementations can enforce
 * independent floors.
 */
