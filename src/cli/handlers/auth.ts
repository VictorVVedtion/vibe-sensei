...
export async function installOAuthTokens(tokens: OAuthTokens): Promise<void> {
  ...
  if (storageResult.warning) {
    logEvent('vs_oauth_storage_warning', {
      warning:
...
export async function authLogin({
  ...
  if (envRefreshToken) {
    ...
    try {
      logEvent('vs_login_from_refresh_token', {})
  ...
  try {
    logEvent('vs_oauth_flow_start', { loginWithClaudeAi })
    ...
    logEvent('vs_oauth_success', { loginWithClaudeAi })
