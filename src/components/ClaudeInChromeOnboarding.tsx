...
export function ClaudeInChromeOnboarding(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = () => {
      logEvent("vs_claude_in_chrome_onboarding_shown", {});
  ...
  let t5;
  if ($[6] !== t4) {
    t5 = <Text>Claude in Chrome works with the Chrome extension to let you control your browser directly from Vibe Sensei. You can navigate websites, fill forms, capture screenshots, record GIFs, and debug with console logs and network requests.{t4}</Text>;
    $[6] = t4;
    $[7] = t5;
  } else {
    t5 = $[7];
