...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@Vibe Sensei - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'Vibe Sensei Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/VictorVVedtion/vibe-sensei-action/blob/main/examples/">https://github.com/VictorVVedtion/vibe-sensei-action/blob/main/examples/</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
