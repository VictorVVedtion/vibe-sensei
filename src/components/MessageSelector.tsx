...
export function MessageSelector({
  ...
  useEffect(() => {
    logEvent('vs_message_selector_opened', {});
  }, []);
  ...
  async function handleSelect(message_0: UserMessage) {
    ...
    logEvent('vs_message_selector_selected', {
  ...
  async function onSelectRestoreOption(option: RestoreOption) {
    logEvent('vs_message_selector_restore_option_selected', {
  ...
  const handleEscape = useCallback(() => {
    ...
    logEvent('vs_message_selector_cancelled', {});
    onClose();
