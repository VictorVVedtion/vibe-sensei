...
// Vibe Sensei: torii gate (⛩️) — the gateway to trading wisdom
// 3 rows: top beam, gate pillars with kanji-style center, base
...
// Apple Terminal: simplified torii
...
export function Clawd(t0) {
  ...
  if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text color="clawd_body" backgroundColor="clawd_background"> 師 </Text>;
    $[16] = t8;
  } else {
    t8 = $[16];
  }
...
function AppleTerminalClawd(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text backgroundColor="clawd_body">{" 師  "}</Text>;
