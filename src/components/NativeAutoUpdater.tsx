...
export function NativeAutoUpdater({
  ...
  const checkForUpdates = React.useCallback(async () => {
    ...
    logEvent('vs_native_auto_updater_start', {});
    try {
      ...
      if (result.lockFailed) {
        logEvent('vs_native_auto_updater_lock_contention', {
      ...
      if (result.wasUpdated) {
        logEvent('vs_native_auto_updater_success', {
          latency_ms: latencyMs
        });
        onAutoUpdaterResult({
        ...
        // Already up to date
        logEvent('vs_native_auto_updater_up_to_date', {
          latency_ms: latencyMs
        });
      }
    } catch (error) {
      ...
      logEvent('vs_native_auto_updater_fail', {
        latency_ms: latencyMs,
