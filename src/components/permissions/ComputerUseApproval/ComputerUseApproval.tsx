...
import { getSentinelCategory } from '@vibe-sensei/computer-use-mcp/sentinelApps';
import type { CuPermissionRequest, CuPermissionResponse } from '@vibe-sensei/computer-use-mcp/types';
import { DEFAULT_GRANT_FLAGS } from '@vibe-sensei/computer-use-mcp/types';
...
function ComputerUseTccPanel(t0) {
  ...
  if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Text dimColor={true}>Grant the missing permissions in System Settings, then select "Try again". macOS may require you to restart Vibe Sensei after granting Screen Recording.</Text>;
    $[15] = t7;
  } else {
    t7 = $[15];
  }
