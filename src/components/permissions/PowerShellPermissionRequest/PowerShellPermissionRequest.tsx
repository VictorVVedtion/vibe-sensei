...
export function PowerShellPermissionRequest(props: PermissionRequestProps): React.ReactNode {
  ...
  const destructiveWarning = getFeatureValue_CACHED_MAY_BE_STALE('vs_destructive_command_warning', false) ? getDestructiveCommandWarning(command) : null;
  ...
  function onSelect(value: string) {
    ...
    logEvent('vs_permission_request_option_selected', {
