...
const GITHUB_ISSUES_REPO_URL = 'https://github.com/VictorVVedtion/vibe-sensei/issues';
type Props = {
  ...
  const submitReport = useCallback(async () => {
    ...
    if (result.success) {
      if (result.feedbackId) {
        ...
        logEvent('vs_bug_report_submitted', {
        ...
        logEventTo1P('vs_bug_report_description', {
          feedback_id: result.feedbackId as AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS,
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Vibe Sensei&apos;s functionality (eg. to reduce the risk of bugs
