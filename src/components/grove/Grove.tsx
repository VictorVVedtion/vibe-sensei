  ...
  if ($[0] !== location || $[1] !== onDone || $[2] !== showIfAlreadyViewed) {
    t1 = () => {
      const checkGroveSettings = async function checkGroveSettings() {
        ...
        logEvent("vs_grove_policy_viewed", {
  ...
  if ($[5] !== groveConfig?.notice_is_grace_period || $[6] !== onDone) {
    t3 = async function onChange(value) {
      bb21: switch (value) {
        case "accept_opt_in":
          {
            ...
            logEvent("vs_grove_policy_submitted", {
              state: true,
        ...
        case "defer":
          {
            logEvent("vs_grove_policy_dismissed", {
              state: true
            });
            break bb21;
          }
        case "escape":
          {
            logEvent("vs_grove_policy_escaped", {});
          }
      }
      onDone(value);
    };
...
function _temp2() {
  logEvent("vs_grove_privacy_settings_viewed", {});
}
