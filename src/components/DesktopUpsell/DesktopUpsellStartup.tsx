...
export function getDesktopUpsellConfig(): DesktopUpsellConfig {
  return getDynamicConfig_CACHED_MAY_BE_STALE('vs_desktop_upsell', DESKTOP_UPSELL_DEFAULT);
}
...
export function DesktopUpsellStartup(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = {
      label: "Open in Vibe Sensei Desktop",
      value: "try" as const
    };
    $[5] = t3;
  } else {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box marginBottom={1}><Text>Same Vibe Sensei with visual diffs, live app preview, parallel sessions, and more.</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
  ...
  if ($[11] !== handleSelect || $[12] !== t7) {
    t8 = <PermissionDialog title="Try Vibe Sensei Desktop"><Box flexDirection="column" paddingX={2} paddingY={1}>{t6}<Select options={options} onChange={handleSelect} onCancel={t7} /></Box></PermissionDialog>;
    $[11] = handleSelect;
    $[12] = t7;
    $[13] = t8;
  } else {
...
function _temp() {
  ...
  logEvent("vs_desktop_upsell_shown", {
    seen_count: newCount
  });
}
