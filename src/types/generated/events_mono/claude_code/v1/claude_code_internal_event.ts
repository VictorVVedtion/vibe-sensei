 ...
 * See vibe-sensei/src/services/statsig.ts for the source of these fields
 */
...
/**
 * ClaudeCodeInternalEvent represents events logged from Vibe Sensei via Statsig
 * This schema matches the structure in vibe-sensei/src/services/statsig.ts
 * Source table: proj-product-data-nhme.raw_statsig_internal_tools.events
 */
export interface ClaudeCodeInternalEvent {
  /** Event name (e.g., "vs_binary_feedback", "vs_api_success") */
