...
export const WikiOperationEventSchema = KBEventBaseSchema.extend({
  type: z.literal('wiki_operation'),
  operation: z.enum(['compile', 'query', 'ingest', 'lint']),
  details: z.string(),
  articlesAffected: z.number().optional(),
})

export type WikiOperationEvent = z.infer<typeof WikiOperationEventSchema>
