...
export async function checkManagedSettingsSecurity(cachedSettings: SettingsJson | null, newSettings: SettingsJson | null): Promise<SecurityCheckResult> {
  ...
  logEvent('vs_managed_settings_security_dialog_shown', {});
      ...
      const {
        unmount
          ...
          <KeybindingSetup>
            ...
            logEvent('vs_managed_settings_security_dialog_accepted', {});
            unmount();
            void resolve('approved');
          }} onReject={() => {
            logEvent('vs_managed_settings_security_dialog_rejected', {});
            unmount();
