 ...
 * terminal — it's the allowlist (vs_harbor_ledger). A compromised
...
/**
 * GrowthBook runtime gate — separate from the channels gate (vs_harbor)
...
export function isChannelPermissionRelayEnabled(): boolean {
  return getFeatureValue_CACHED_MAY_BE_STALE('vs_harbor_permissions', false)
}
