...
/**
 * Get Vibe Sensei MCP configurations (excludes claude.ai servers from the
 ...
 * @returns Vibe Sensei server configurations with appropriate scopes
 */
...
export function setMcpServerEnabled(name: string, enabled: boolean): void {
  ...
  if (isBuiltinStateChange) {
    logEvent('vs_builtin_mcp_toggle', {
      serverName:
