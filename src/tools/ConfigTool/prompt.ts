...
export const DESCRIPTION = 'Get or set Vibe Sensei configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Vibe Sensei configuration settings.

  View or change Vibe Sensei settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
