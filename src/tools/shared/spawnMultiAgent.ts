...
export type SpawnTeammateConfig = {
   ...
   *  lineage tracing on vs_api_* events. */
...
async function handleSpawnSplitPane(
  ...
  // Build the command to spawn Vibe Sensei with teammate identity
...
/**
 * Handle spawn operation - creates a new Vibe Sensei instance.
