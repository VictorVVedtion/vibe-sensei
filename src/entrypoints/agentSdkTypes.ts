/**
 * Main entrypoint for Vibe Sensei Agent SDK types.
 *
 ...
 * `vs_kairos_cron_config` GrowthBook config in CLI sessions; daemon hosts
 ...
 * → reconfigure).
 *
 * Skips the `vs_ccr_bridge` gate and policy-limits check — @internal
