...
export const init = memoize(async (): Promise<void> => {
  ...
  try {
    ...
    void Promise.all([
      ...
      // Rebuild the logger provider if vs_1p_event_batch_config changes
    ...
    // Register paper trading venues (futures, prediction, DEX) in VenueRegistry.
    // Non-blocking fire-and-forget — errors logged but never block startup.
    void import('../services/exchange/venue-bootstrap.js').then(m => m.bootstrapPaperVenues())
