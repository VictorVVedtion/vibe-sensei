/**
 * Guardian Persona Prompt System — makes each of the 68 masters speak in character.
...
const MASTER_ARCHETYPE_MAP: Record<Master, Archetype> = {
  ...
  justin_sun: 'crypto_native',
  brian_armstrong: 'crypto_native',
  barry_silbert: 'crypto_native',
  michael_saylor: 'crypto_native',
  do_kwon: 'crypto_native',
  su_zhu: 'crypto_native',
  sbf: 'crypto_native',
  kyle_davies: 'crypto_native',

  // US Macro / Regulators (Fed, Treasury, SEC)
  powell: 'macro_trader',
  yellen: 'macro_trader',
  gary_gensler: 'strategist',

  // Innovation / Disruption
  cathie_wood: 'first_principles',
