...
// 68 historical trading/philosophy masters as guardian personas.
...
export const MASTERS = [
  ...
  'justin_sun',          // U — distribution beats elegance
  'brian_armstrong',     // U — build the rails
  'barry_silbert',       // U — ecosystem compounding
  'michael_saylor',      // R — bitcoin maximalism

  // Crypto Degen Legends (1) — extreme leverage, meme-tier fame
  'liangxi',             // R — rolling positions, 1000→10M, 100x leverage

  // Crypto Cautionary Veterans (4) — collapsed empires, hard-won lessons
  'do_kwon',             // U — reflexivity cuts both ways
  'su_zhu',              // U — supercycle thesis post-mortem
  'sbf',                 // U — books and trades in same hands
  'kyle_davies',         // U — conviction without risk controls

  // US Macro / Regulators (3) — rule-setters who move markets
  'powell',              // R — higher for longer
  'yellen',              // R — long-term vs short-term face
  'gary_gensler',        // U — counterparty awareness

  // Innovation / Disruption (1)
  'cathie_wood',         // R — bet on the curve, not the level
...
export const MASTER_NAMES: Record<Master, string> = {
  ...
  kyle_davies: 'Kyle Davies',
  powell: 'Jerome Powell',
  yellen: 'Janet Yellen',
  gary_gensler: 'Gary Gensler',
...
export const MASTER_QUOTES: Record<Master, string> = {
  ...
  justin_sun: 'Adoption beats elegance — distribution is the moat in crypto.',
  brian_armstrong: 'Build the rails. The trades will follow.',
  barry_silbert: 'Ecosystems compound, but so do hidden liabilities.',
  michael_saylor: 'There is no second best — concentrate, then convict.',
  do_kwon: '95% are going to die. The art is knowing whether you are in the 5%.',
  su_zhu: 'Each cycle, the floor moves up — until it doesn\'t.',
  sbf: 'When the books and the trades live in the same hands, the books eventually lose.',
  kyle_davies: 'Conviction without risk controls is just velocity into a wall.',
  powell: 'Higher for longer is the lesson of every premature pivot.',
  yellen: 'Every economic problem has a long-term face and a short-term face. Watch both.',
  gary_gensler: "If you don't know who's the counterparty, you are the counterparty.",
  cathie_wood: 'Innovation compounds nonlinearly — bet on the curve, not the level.',
...
export const MASTER_RARITY: Record<Master, Rarity> = {
  ...
  michael_saylor: 'rare', powell: 'rare', yellen: 'rare', cathie_wood: 'rare',
  // Uncommon (20)
  ...
  xu_mingxing: 'uncommon', justin_sun: 'uncommon',
  do_kwon: 'uncommon', su_zhu: 'uncommon',
  brian_armstrong: 'uncommon', barry_silbert: 'uncommon',
  sbf: 'uncommon', kyle_davies: 'uncommon',
  gary_gensler: 'uncommon',
  // Rare — Crypto Degen Legend (1)
  liangxi: 'rare',
  // Common (1)
...
export const GHOST_WARNINGS = [
  ...
  { id: 'bitmex_rekt', name: 'BitMEX Rekt Trader', trigger: 'overleveraged_margin', quote: 'REKT. 100x felt invincible until the wick.' },
  { id: 'bill_hwang', name: 'Bill Hwang / Archegos', trigger: 'concentrated_leverage', quote: 'Total return swaps hide nothing from the margin call.' },
] as const
