...
/**
 * Personality-driven ASCII portraits for all 68 guardian masters.
 *
 * Design rules:
...
export const MASTER_PORTRAITS: Record<Master, MasterPortrait> = {
  ...
  // 凉兮 — young degen, wild eyes, lightning bolt (100x leverage energy)
  liangxi: {
    portrait: [
      '  ▄▄⚡▄▄▄  ',
      '  ▌◉    ◉▐  ',
  ...
  // Justin Sun — round face, glasses, social grin
  justin_sun: {
    portrait: [
      '    ▄▄▄▄     ',
      '  ▌◎    ◎▐  ',
  ...
  // Do Kwon — sharp jaw, hollow stare (post-collapse)
  do_kwon: {
    portrait: [
      '    ▄▄▄▄     ',
      '  ▌·    ·▐  ',
  ...
  // Su Zhu — broad face, exhausted eyes (post-3AC)
  su_zhu: {
    portrait: [
      '   ▄▀▀▀▄    ',
      '  ▌○    ○▐  ',
  ...
  // SBF — messy curls, hollow unblinking stare
  sbf: {
    portrait: [
      '   ▄∩▄∩▄    ',
      '  ▌◎    ◎▐  ',
  ...
  // Kyle Davies — 3AC co-founder, longer hair
  kyle_davies: {
    portrait: [
      '   ▄▄▄▄▌    ',
      '  ▌○    ○▐  ',
  ...
  // Brian Armstrong — clean cut, square glasses
  brian_armstrong: {
    portrait: [
      '    ▄▄▄▄     ',
      '  ▌□    □▐  ',
  ...
  // Barry Silbert — clean cut, sharp focus
  barry_silbert: {
    portrait: [
      '    ▄▄▄▄     ',
      '  ▌●    ●▐  ',
  ...
  // Gary Gensler — bald regulator, stern
  gary_gensler: {
    portrait: [
      '    ░░░░     ',
      '  ▌·    ·▐  ',
  ...
  // ═══════════════════════════════════════════════════════════
  // RARE additions (4) — newly registered orphans
  // ═══════════════════════════════════════════════════════════

  // Michael Saylor — slick back, BTC diamond eyes
  michael_saylor: {
    portrait: [
      '    ▀▀▀▀     ',
      '  ▌◆    ◆▐  ',
  ...
  // Jerome Powell — silver hair, measured
  powell: {
    portrait: [
      '   ░▄▄▄░    ',
      '  ▌○    ○▐  ',
  ...
  // Janet Yellen — short white bob, warm
  yellen: {
    portrait: [
      '   ░▀▀▀░    ',
      '  ▌·    ·▐  ',
