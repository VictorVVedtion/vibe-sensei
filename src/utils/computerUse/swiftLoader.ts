import type { ComputerUseAPI } from '@vibe-sensei/computer-use-swift'
...
export function requireComputerUseSwift(): ComputerUseAPI {
  if (process.platform !== 'darwin') {
    throw new Error('@vibe-sensei/computer-use-swift is macOS-only')
  }
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  return (cached ??= require('@vibe-sensei/computer-use-swift') as ComputerUseAPI)
}
