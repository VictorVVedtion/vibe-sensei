import type {
  ComputerUseInput,
  ComputerUseInputAPI,
} from '@vibe-sensei/computer-use-input'
...
export function requireComputerUseInput(): ComputerUseInputAPI {
  ...
  const input = require('@vibe-sensei/computer-use-input') as ComputerUseInput
  if (!input.isSupported) {
    throw new Error('@vibe-sensei/computer-use-input is not supported on this platform')
  }
  return (cached = input)
}
