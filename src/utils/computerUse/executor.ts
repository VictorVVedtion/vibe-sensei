 ...
 *   - `@vibe-sensei/computer-use-input` (Rust/enigo) — mouse, keyboard, frontmost app
 *   - `@vibe-sensei/computer-use-swift` — SCContentFilter screenshots, NSWorkspace apps, TCC
 *
...
import type {
  ...
  RunningApp,
  ScreenshotResult,
} from '@vibe-sensei/computer-use-mcp'

import { API_RESIZE_PARAMS, targetImageSize } from '@vibe-sensei/computer-use-mcp'
