...
export type Theme = {
  ...
  // Vibe Sensei operator dashboard tokens
  accent: string           // Primary green accent (desktop's #9cff93)
  accentDim: string        // Dimmed green for secondary elements
  frameBorder: string      // Panel/frame border color
  frameBorderDim: string   // Subtle border for background frames
  panelLabel: string       // Bracket label text [OPERATOR] etc.
}
...
const lightTheme: Theme = {
  ...
  // Vibe Sensei operator dashboard
  accent: 'rgb(44,122,57)',            // Muted green for light bg
  accentDim: 'rgb(22,61,29)',          // Dark green
  frameBorder: 'rgb(180,180,180)',     // Light gray border
  frameBorderDim: 'rgb(220,220,220)',  // Very light border
  panelLabel: 'rgb(44,122,57)',        // Green label
}
...
const lightAnsiTheme: Theme = {
  ...
  // Vibe Sensei operator dashboard
  accent: 'ansi:green',
  accentDim: 'ansi:green',
  frameBorder: 'ansi:white',
  frameBorderDim: 'ansi:blackBright',
  panelLabel: 'ansi:green',
}
...
const lightDaltonizedTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Vibe Sensei operator dashboard
  accent: 'rgb(0,102,153)',            // Blue accent for daltonized
  accentDim: 'rgb(0,51,77)',           // Dark blue
  frameBorder: 'rgb(180,180,180)',     // Light gray
  frameBorderDim: 'rgb(220,220,220)',  // Very light
  panelLabel: 'rgb(0,102,153)',        // Blue label
}
...
const darkTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Vibe Sensei operator dashboard
  accent: 'rgb(156,255,147)',          // Phosphor green (#9cff93)
  accentDim: 'rgb(0,236,59)',          // Bright green dim (#00ec3b)
  frameBorder: 'rgb(72,72,72)',        // Outline variant (#484848)
  frameBorderDim: 'rgb(38,38,38)',     // Surface variant (#262626)
  panelLabel: 'rgb(156,255,147)',      // Same as accent
}
...
const darkDaltonizedTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Vibe Sensei operator dashboard
  accent: 'rgb(51,153,255)',           // Blue accent for daltonized dark
  accentDim: 'rgb(25,77,128)',         // Dark blue
  frameBorder: 'rgb(72,72,72)',        // Outline variant
  frameBorderDim: 'rgb(38,38,38)',     // Surface variant
  panelLabel: 'rgb(51,153,255)',       // Blue label
}
