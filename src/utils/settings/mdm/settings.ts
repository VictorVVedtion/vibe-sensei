/**
 * MDM (Mobile Device Management) profile enforcement for Vibe Sensei managed settings.
 *
 ...
 * - Linux: No MDM equivalent (uses /etc/vibe-sensei/managed-settings.json instead)
 *
