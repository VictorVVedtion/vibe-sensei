...
/**
 * The JSON Schema URL for Vibe Sensei settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/vibe-sensei-settings.json
 */
export const CLAUDE_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/vibe-sensei-settings.json'
