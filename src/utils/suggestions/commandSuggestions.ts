 ...
 * Claude Code commands. Identification is by name because the underlying
...
export function generateCommandSuggestions(
  ...
  if (query === '') {
    ...
    // scrolling past 80+ inherited Claude Code commands.
    ...
    // the user never has to scroll past inherited Claude Code skills to
  ...
  // when the query also matches inherited Claude Code commands (e.g.
