...
// Always ask when Vibe Sensei tries to edit its own config files
 ...
 * Controlled by the vs_scratch Statsig gate.
 */
export function isScratchpadEnabled(): boolean {
  return checkStatsigFeatureGate_CACHED_MAY_BE_STALE('vs_scratch')
}
 ...
 * This is a per-user temporary directory used by Vibe Sensei for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Vibe Sensei)
