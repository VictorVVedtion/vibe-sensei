...
// How often to re-fetch vs_kairos_cron_config from GrowthBook. Short because
...
/**
 * Read `vs_kairos_cron_config` from GrowthBook, validate, fall back to
