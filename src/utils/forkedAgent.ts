 ...
 * 3. Log metrics via the vs_fork_agent_query event when complete
 ...
 * 3. Logs vs_fork_agent_query with full usage when complete
 *
 * @example
 * ```typescript
...
/**
 * Logs the vs_fork_agent_query event with full NonNullableUsage fields.
 */
