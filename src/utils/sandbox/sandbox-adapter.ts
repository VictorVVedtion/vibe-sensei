...
/**
 * Resolve Vibe Sensei-specific path patterns for sandbox-runtime.
 *
 * Vibe Sensei uses special path prefixes in permission rules:
...
/**
 * Convert Vibe Sensei settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Vibe Sensei started)
...
// scrubbed if they appear after a sandboxed command. See VictorVVedtion/vibe-sensei#29316.
 ...
 * bareGitRepoFiles. VictorVVedtion/vibe-sensei#29316.
 */
