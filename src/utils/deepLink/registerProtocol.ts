...
const APP_NAME = 'Vibe Sensei URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Vibe Sensei URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Vibe Sensei Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Vibe Sensei
...
export async function ensureDeepLinkProtocolRegistered(): Promise<void> {
  ...
  if (!getFeatureValue_CACHED_MAY_BE_STALE('vs_lodestone_enabled', false)) {
    return
  }
